...
//import net.minecraft.server.v1_20_R3.IWorldReader;
import net.minecraft.world.level.IWorldReader;
//import net.minecraft.server.v1_20_R3.NavigationAbstract;
import net.minecraft.world.entity.ai.navigation.NavigationAbstract;
//import net.minecraft.server.v1_20_R3.PathEntity;
import net.minecraft.world.level.pathfinder.PathEntity;
//import net.minecraft.server.v1_20_R3.PathType;
import net.minecraft.world.level.pathfinder.PathType;
//import net.minecraft.server.v1_20_R3.PathfinderGoal;
import net.minecraft.world.entity.ai.goal.PathfinderGoal;
//import net.minecraft.server.v1_20_R3.PathfinderNormal;
