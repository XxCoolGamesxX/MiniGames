package me.patothebest.gamecore.nms.v1_20_R3;

import com.google.common.collect.Sets;
import me.patothebest.gamecore.nms.v1_20_R3.goals.PathfinderGoalBlazeFireball;
import me.patothebest.gamecore.nms.v1_20_R3.goals.PathfinderGoalFollowOwner;
import me.patothebest.gamecore.nms.v1_20_R3.goals.PathfinderGoalOwnerHurtTarget;
import me.patothebest.gamecore.nms.v1_20_R3.goals.PathfinderGoalShulkerShoot;
import me.patothebest.gamecore.itemstack.Material;
import me.patothebest.gamecore.nms.NMS;
import me.patothebest.gamecore.nms.v1_20_R3.goals.PathfinderGoalGhastAttackTarget;
import me.patothebest.gamecore.nms.v1_20_R3.goals.PathfinderGoalOwnerHurtByTarget;
import me.patothebest.gamecore.util.Utils;
//import net.minecraft.server.v1_20_R3.BlockPosition;
import net.minecraft.core.BlockPosition;
//import net.minecraft.server.v1_20_R3.DragonControllerPhase;
import net.minecraft.world.entity.boss.enderdragon.phases.DragonControllerPhase;
//import net.minecraft.server.v1_20_R3.Entity;
import 	net.minecraft.world.entity.Entity;
//import net.minecraft.server.v1_20_R3.EntityArmorStand;
import net.minecraft.world.entity.decoration.EntityArmorStand;
//import net.minecraft.server.v1_20_R3.EntityBlaze;
import net.minecraft.world.entity.monster.EntityBlaze;
//import net.minecraft.server.v1_20_R3.EntityCreature;
import net.minecraft.world.entity.EntityCreature;
//import net.minecraft.server.v1_20_R3.EntityCreeper;
import net.minecraft.world.entity.monster.EntityCreeper;
//import net.minecraft.server.v1_20_R3.EntityEnderDragon;
import net.minecraft.world.entity.boss.enderdragon.EntityEnderDragon;
//import net.minecraft.server.v1_20_R3.EntityGhast;
import net.minecraft.world.entity.monster.EntityGhast;
//import net.minecraft.server.v1_20_R3.EntityInsentient;
import net.minecraft.world.entity.EntityInsentient;
//import net.minecraft.server.v1_20_R3.EntityItem;
import net.minecraft.world.entity.item.EntityItem;
//import net.minecraft.server.v1_20_R3.EntityShulker;
import net.minecraft.world.entity.monster.EntityShulker;
//import net.minecraft.server.v1_20_R3.EntitySkeletonAbstract;
import net.minecraft.world.entity.monster.EntitySkeletonAbstract;
//import net.minecraft.server.v1_20_R3.EntityTypes;
import net.minecraft.world.entity.EntityTypes;
//import net.minecraft.server.v1_20_R3.EntityWitch;
import net.minecraft.world.entity.monster.EntityWitch;
//import net.minecraft.server.v1_20_R3.NBTTagCompound;
import net.minecraft.nbt.NBTTagCompound;
//import net.minecraft.server.v1_20_R3.PathfinderGoal;
import net.minecraft.world.entity.ai.goal.PathfinderGoal;
//import net.minecraft.server.v1_20_R3.PathfinderGoalArrowAttack;
import net.minecraft.world.entity.ai.goal.PathfinderGoalArrowAttack;
//import net.minecraft.server.v1_20_R3.PathfinderGoalBowShoot;
import net.minecraft.world.entity.ai.goal.PathfinderGoalBowShoot;
//import net.minecraft.server.v1_20_R3.PathfinderGoalFloat;
import net.minecraft.world.entity.ai.goal.PathfinderGoalFloat;
//import net.minecraft.server.v1_20_R3.PathfinderGoalHurtByTarget;
import net.minecraft.world.entity.ai.goal.target.PathfinderGoalHurtByTarget;
//import net.minecraft.server.v1_20_R3.PathfinderGoalMeleeAttack;
import net.minecraft.world.entity.ai.goal.PathfinderGoalMeleeAttack;
//import net.minecraft.server.v1_20_R3.PathfinderGoalSelector;
import net.minecraft.world.entity.ai.goal.PathfinderGoalSelector;
//import net.minecraft.server.v1_20_R3.PathfinderGoalSwell;
import net.minecraft.world.entity.ai.goal.PathfinderGoalSwell;
//import net.minecraft.server.v1_20_R3.TileEntityChest;
import net.minecraft.world.level.block.entity.TileEntityChest;
//import net.minecraft.server.v1_20_R3.World;
