...
//import net.minecraft.server.v1_20_R3.DataWatcherObject;
import net.minecraft.network.syncher.DataWatcherObject;
//import net.minecraft.server.v1_20_R3.EntityBlaze;
import net.minecraft.world.entity.monster.EntityBlaze;
//import net.minecraft.server.v1_20_R3.EntityHuman;
import net.minecraft.world.entity.player.EntityHuman;
//import net.minecraft.server.v1_20_R3.EntityLiving;
import net.minecraft.world.entity.EntityLiving;
//import net.minecraft.server.v1_20_R3.EntitySmallFireball;
import net.minecraft.world.entity.projectile.EntitySmallFireball;
//import net.minecraft.server.v1_20_R3.GenericAttributes;
import net.minecraft.world.entity.ai.attributes.GenericAttributes;
//import net.minecraft.server.v1_20_R3.MathHelper;
