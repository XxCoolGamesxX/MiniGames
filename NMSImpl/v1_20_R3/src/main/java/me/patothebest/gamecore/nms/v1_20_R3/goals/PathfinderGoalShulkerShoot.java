...
//import net.minecraft.server.v1_20_R3.EntityShulkerBullet;
import net.minecraft.world.entity.projectile.EntityShulkerBullet;
//import net.minecraft.server.v1_20_R3.EnumDifficulty;
import net.minecraft.world.EnumDifficulty;
//import net.minecraft.server.v1_20_R3.PathfinderGoal;
import net.minecraft.world.entity.ai.goal.PathfinderGoal;
//import net.minecraft.server.v1_20_R3.SoundEffects;
